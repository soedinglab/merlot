...
Top left: (A) MERLoT full, top right: (B) MERLoT reduced, bottom left (C) ElPi full, bottom right (D) ElPi reduced.
...
par(mfrow=c(3, 6))
gene <- "Klf1"
plot_pseudotime_expression_gene(gene , EmbeddedTree, elastic_full_merlot_pt, addlegend = F, selectedcolors = plot_cols)
plot_pseudotime_expression_gene(gene , EmbeddedTree, elastic_reduced_merlot_pt, addlegend = F, selectedcolors = plot_cols)
plot_pseudotime_expression_gene(gene , EmbeddedTree, elastic_full_elpi_pt, addlegend = F, selectedcolors = plot_cols)
plot_pseudotime_expression_gene(gene , EmbeddedTree, elastic_reduced_elpi_pt, addlegend = F, selectedcolors = plot_cols)
plot_pseudotime_expression_gene(gene , EmbeddedTree, elpi_full_elpi_pt, addlegend = F, selectedcolors = plot_cols)
plot_pseudotime_expression_gene(gene , EmbeddedTree, elpi_full_merlot_pt, addlegend = F, selectedcolors = plot_cols)
gene <- "Cebpa"
plot_pseudotime_expression_gene(gene , EmbeddedTree, elastic_full_merlot_pt, addlegend = F, selectedcolors = plot_cols)
plot_pseudotime_expression_gene(gene , EmbeddedTree, elastic_reduced_merlot_pt, addlegend = F, selectedcolors = plot_cols)
plot_pseudotime_expression_gene(gene , EmbeddedTree, elastic_full_elpi_pt, addlegend = F, selectedcolors = plot_cols)
